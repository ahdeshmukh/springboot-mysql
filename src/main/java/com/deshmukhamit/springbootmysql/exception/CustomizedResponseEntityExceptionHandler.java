...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ErrorDetails> handleAllExceptions(Exception ex, WebRequest request) {
        return new ResponseEntity<>(this.getErrorDetails(ex, request), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public final ResponseEntity<ErrorDetails> handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
        return new ResponseEntity<>(this.getErrorDetails(ex, request), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(PersistenceException.class)
    public final ResponseEntity<ErrorDetails> handlePersistenceException(PersistenceException ex, WebRequest request) {
        return new ResponseEntity<>(this.getErrorDetails(ex, request), HttpStatus.BAD_GATEWAY);
    }
